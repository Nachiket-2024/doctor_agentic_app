...
from ..services.doctor_slot.get_available_slots_by_doctor_id import get_available_slots_by_doctor_id_service
...
async def get_available_slots(
    ...
    """
    return await get_available_slots_by_doctor_id_service(doctor_id, date_str, db)